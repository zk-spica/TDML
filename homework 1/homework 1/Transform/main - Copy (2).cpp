...
struct TempProperty
{
	...
	void loadProperty(Property *property, DOMNode *parentNode, DOMNode *currentNode)
	{
...
void drawDOMTree(DOMNode *currentNode, DOMNode *parentNode)
{
	...
	{
		tempProperty.loadProperty(*property, parentNode, currentNode);
	}	
	...
	if (currentNode->tagName == DOMNode::cuboid)
	{
		...
		if (tempProperty.type == 'w')
		{
			...
			GLfloat mat_ambient[]  = {tempProperty.r, tempProperty.g, tempProperty.b, 1};
			GLfloat mat_diffuse[]  = {tempProperty.r, tempProperty.g, tempProperty.b, 1};
		...
		if (tempProperty.type == 's')
		{
			...
			drawQuadrilateral(vertex[7], vertex[6], vertex[4], vertex[5], currentNode->texture_x_positive, tempProperty.r, tempProperty.g, tempProperty.b);
