...
{
       0,     0,     3,     6,     8,    12,    17,    22,    25,    27
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      10,     0,    -1,    10,    11,    -1,    11,    -1,     5,    12,
       6,    -1,     5,    12,     7,     6,    -1,     5,     7,     3,
       6,    -1,    12,    13,    -1,     3,    -1,     3,     8,     4,
      -1
};
...
{
  "$end", "error", "$undefined", "NAME", "VALUE", "'<'", "'>'", "'/'",
  "'='", "$accept", "S", "comlabel", "label", "property", 0
};
#endif
...
#line 61 "new.y"
    {
		...
		//printf("SS:%s\n",tmp->name);
		tmp->name = (yyvsp[(1) - (3)]); tmp->val = (yyvsp[(3) - (3)]);
		tmp->next = NULL;
		(yyval) = (char *)tmp;
	;}
    break;
